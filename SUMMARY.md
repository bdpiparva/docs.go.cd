...
* [Installing Go](installation/index.md)
    ...
    * [Installing Go Server](installation/installing_go_server.md)
        * [Linux](installation/install/server/linux.md)
        * [Windows](installation/install/server/windows.md)
        * [Mac OS X](installation/install/server/osx.md)
        * [Solaris](installation/install/server/solaris.md)
        * [Generic Zip](installation/install/server/zip.md)
    * [Installing Go Agent](installation/installing_go_agent.md)
        * [Linux](installation/install/agent/linux.md)
        * [Windows](installation/install/agent/windows.md)
        * [Mac OS X](installation/install/agent/osx.md)
        * [Solaris](installation/install/agent/solaris.md)
        * [Generic Zip](installation/install/agent/zip.md)
